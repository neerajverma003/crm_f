...
const DocsComponents = (props) => (
    <div className="bg-primary border-primary mb-4 rounded border border-2 bg-opacity-10">
        <div className="row d-flex align-items-center px-xl-4 flex-xl-nowrap p-3">
            ...
            <div className="col-md col-12 px-lg-4">
                ...
                <strong>the only open-source React dashboard built on a professional, enterprise-grade UI Components Library</strong>. This component
                is part of this library, and we present only the basic usage of it here. To explore extended examples, detailed API documentation, and
                customization options, refer to our docs.
            </div>
            <div className="col-md-auto col-12 mt-lg-0 mt-3">
                <a
