            ...
            >
                ...
                <td className="flex gap-2 px-4 py-3">
                    <button
                        ...
                        className="rounded-full bg-blue-100 p-2 text-blue-600 shadow-sm hover:bg-blue-200"
                        title="View Details"
                    >
                        <Eye size={16} />
                    </button>
    ...
    const MonthlyAttendanceGrid = ({ attendanceData, month }) => {
        ...
        for (let i = 1; i <= daysInMonth; i++) {
            ...
            days.push(
                <div
                    key={i}
                    className={`cursor-pointer rounded-xl border-2 p-4 hover:scale-105 hover:shadow-lg ${getStatusColor(status)}`}
                >
